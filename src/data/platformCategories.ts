...
import employeeDocuments from '@/assets/images/employee-documents.png'
import timesheetDetails from '@/assets/images/timesheet-details.png'
import salesTracker from '@/assets/images/sales-tracker.png'
...
export const platformCategories: PlatformCategoryDetail[] = [
  ...
  },
  {
    ...
    screenshot: employeeDocuments,
    screenshotAlt:
      'LaneOps employee documents screen showing safety certifications and signed forms',
    screenshotChrome: false,
    sections: [
      {
  ...
  },
  {
    ...
    screenshot: timesheetDetails,
    screenshotAlt: 'LaneOps timesheet detail screen showing hours, status, and approval history',
    screenshotChrome: false,
    sections: [
      {
  ...
  },
  {
    ...
    screenshot: salesTracker,
    screenshotAlt: 'LaneOps sales tracker screen showing invoiced and outstanding billing by job',
    screenshotChrome: false,
    sections: [
      {
